<template>
	<div v-show="isVisible" :id="id" class="absolute z-[99999] inset-0 w-full h-full">
		<div class="absolute w-full h-full bg-white opacity-30" @click="hideModal"></div>
		<div class="absolute bottom-0 left-0 right-0 w-full h-min-100px h-max-1/2 bg-gray-500 py-2">
